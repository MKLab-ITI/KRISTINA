...
public class QueryUtils {
	 ...
	 *            a connection to a repository
	 * @param query
	 *            a SPARQL SELECT query in text form
	 * @param bindings
	...
	public static TupleQueryResult evaluateSelectQuery(RepositoryConnection connection, String query,
			Binding... bindings) throws MalformedQueryException, RepositoryException, QueryEvaluationException {
	 ...
	 *            a connection to a repository
	 * @param query
	 *            a SPARQL CONSTRUCT query in text form
	 * @param bindings
	 *            optional bindings to set on the prepared query
	 ...
	 *            a connection to a repository
	 * @param query
	 *            a SPARQL ASK query in text form
	 * @param bindings
	 *            optional bindings to set on the prepared query
