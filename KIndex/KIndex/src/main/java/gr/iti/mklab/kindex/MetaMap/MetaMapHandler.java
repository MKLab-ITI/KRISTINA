...
public class MetaMapHandler {
	...
	/**
	 *  function to extract concepts from text in file {@value INPUT_FILE}
	 *  output is stored in {@value OUTPUT_FILE} in html format
	 *
	 * @return String. Text from {@value INPUT_FILE} including concepts in <b>BOLD</b>
	 */
	public static void extractFromFileToHTMLFile(String text) {
	...
	/**
	 * Extracts concepts from text provided and returns a Word Array.
	 * All words of the text are in this array.
	 * To figure out if a word is concept, word.isConcept()
	 *
	 * @param text String. Text to be processed for concept extraction
	 * @return ArrayList<Word> An Array with all text words
	 */
	public static ArrayList<MetaMapWord> extractFromTextToWords(String text) {

		String mmOutput = getMetaMapOutput(text);

		System.out.println("------------------------------------------");
		System.out.println("MetaMap Output");
		System.out.println("------------------------------------------");
		System.out.println(mmOutput);
		System.out.println("------------------------------------------");
		return CustomMetaMapParser.extractToWords(mmOutput);
	}
