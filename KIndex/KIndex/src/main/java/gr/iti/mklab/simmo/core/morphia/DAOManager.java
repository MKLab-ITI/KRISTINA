...
public class DAOManager {
    ...
    public void savePDF(PDF pdf) {
        ...
        //Then save the pdf child elements
        saveDocument(pdf);

        //Then save the Webpage
        pdfDAO.save(pdf);

        saveAssociations(pdf.getAssociations());
